...
export default function Home() {
  ...
  const videoModels = (videoModelsQuery.data || []) as CatalogModel[];
  ...
  }, [selectedModel, resolutions, size, supportsQuality]);
  ...
  const submitGeneration = () => {
    ...
    if (modelKind === "video") { setError("El flujo de imagen está activo. Escoge un modelo de la sección Imagen para generar resultados aquí."); return; }
